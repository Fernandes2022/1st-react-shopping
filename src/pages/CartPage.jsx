      ...
      <section className='mb-2'>
        ...
        <div className="container">
          <div className='flex flex-col mb-8 p-8'>
            {cart.map((item) => (
               <div key={item.id} className='mb-6 mx-auto grid grid-cols-3 items-center sm:max-w-3xl border border-t-slate-300 p-4'>
                ...
                <div className="flex items-center p-1 gap-1 border border-slate-300">
        ...
        <div className=" flex bg-gray-400 text-white justify-between p-4 ">
